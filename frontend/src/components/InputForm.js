...
//   }
  ...
  return (
        ...
        <Select placeholder="Select Flavor" onChange={handleSelect}>
        ...
        <Select placeholder="Select Toppings" onChange={handleSelect}>
        ...
        <Button bgGradient='linear(to-r, yellow.400, red.400)' color="white" onSubmit={handleSubmit}>Make Sundae</Button>
        </VStack>
